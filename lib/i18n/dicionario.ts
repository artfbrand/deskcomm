...
export const DICIONARIO: Traducoes = {
  ...
  "no copiloto": { es: "en el copiloto" },
  "automático": { es: "automático" },
  "Não mapeada": { es: "Sin mapear" },
  "Prospecção": { es: "Prospección" },
  "Pré-venda": { es: "Preventa" },
  "Reunião agendada": { es: "Reunión agendada" },
  "Apresentação": { es: "Presentación" },
  "Fechamento": { es: "Cierre" },
  "Pós-venda": { es: "Posventa" },
  "Salvar mapeamento": { es: "Guardar mapeo" },
  "Mapeamento do copiloto salvo.": { es: "Mapeo del copiloto guardado." },
